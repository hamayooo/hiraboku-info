...
======================================================================-->
					...
					<div class="search__content">
						...
						<div class="tab-content tab-content03">
							<form role="search" method="get" id="searchform"
								action="<?php echo esc_url(home_url('/')); ?>shop/">
								...
								<div class="input-list">
									...
									?>
										<li>
											<input type="checkbox" name="get_cats[]" value="<?php echo $term_slug;?>"
												id="<?php echo $term_slug;?>">
				...
				<div class="search__content">
					<div class="tab-content is-active">
						<div class="area-list">
							<div class="area">
								<div class="img img01">
									<img src="<?php echo APP_URL;?>images/common/area01_2.svg" alt="">
								</div>
								<div class="text text01">
									<strong>東北地方</strong>
									<ul>
										<li>
											<a href="<?php echo APP_URL;?>areacat/yamagata/">山形</a>
										</li>
										<li>
											<a href="<?php echo APP_URL;?>areacat/miyagi/">宮城</a>
										</li>
									</ul>
								</div>
							</div>
							<div class="area">
								<div class="img img02">
									<img src="<?php echo APP_URL;?>images/common/area02.svg" alt="">
								</div>
								<div class="text text02">
									<strong>関東地方</strong>
									<ul>
										<li>
											<a href="<?php echo APP_URL;?>areacat/tokyo/">東京</a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="tab-content tab-content02">
						<div class="store-list">
							<a href="<?php echo APP_URL;?>storecat/eat/">
								<div class="img" style="background: url(<?php echo APP_URL;?>images/common/store01.jpg)center center/cover no-repeat;"></div>
								<div class="text">
									<span>飲食店</span>
								</div>
							</a>
							<a href="<?php echo APP_URL;?>storecat/product/">
								<div class="img" style="background: url(<?php echo APP_URL;?>images/common/store02.jpg)center center/cover no-repeat;"></div>
								<div class="text">
									<span>物販店</span>
								</div>
							</a>
	...
	<section class="area-box">
		<div class="inner">
			...
			<?php if($childCat != $prevChildCat): ?>
			<?php if($parentCat == $prevParentCat && $postCount != 0): ?>
			</ul>
		</div>
		</div>
		<?php endif ?>
			...
			<div class="detail">
				<ul class="detail__list">
					...
					<li>
						<div class="img-wrap">
							<div class="img"
								style="background: url(<?php echo $bg_img;?>)center center/cover no-repeat;"></div>
							<div class="cate-list">
								<?php
												...
												$link = get_term_link($term);
											?>
								<a class="label" style="background-color:<?php echo esc_attr($color); ?>;"
									href="<?php echo $link;?>#search-text"><?php echo $term_name; ?></a>
						...
						<div class="text">
							...
							<div class="address">
								...
								<a href="<?php echo get_field('info')['googlemap_url']; ?>" class="googlemap"
									target="_blank">
